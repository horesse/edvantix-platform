 ...
 *
 * A small gradient square carrying the "E" initial, paired with the
 * "Edvantix" wordmark and a small "Оператор" sub-label. Colour-identity is
 * driven by the shared `--color-primary` token.
 */
...
/**
 * BrandMarkXL — splash version for the Login page. Leads with the Edvantix
 * mark + wordmark, then a display heading and a one-line system blurb.
 */
  ...
  return (
    <div className={cn("space-y-3", className)}>
      <div className="flex items-center gap-2.5">
        <span
          aria-hidden
          className="brand-mark grid size-7 shrink-0 place-items-center rounded-lg font-display text-[11px] font-bold text-[var(--color-primary-foreground)]"
        >
          E
        </span>
      ...
      <h1 className="font-display text-[clamp(3rem,7vw,5.5rem)] font-semibold leading-[0.95] tracking-[var(--tracking-display)]">
        Оператор<span className="text-[var(--color-primary)]">.</span>
      </h1>
      <p className="max-w-md text-sm leading-relaxed text-[var(--color-muted-foreground)]">
        Управление всеми школами этого экземпляра — идентификация,
        мультитенантность, биллинг и остальная система в одном месте.
      </p>
    </div>
  );
}
