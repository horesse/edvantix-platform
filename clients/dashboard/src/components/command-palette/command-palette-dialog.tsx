    ...
    const allGroups: ActionGroup[] = [
      {
        ...
        items: [
          ...
          },
          {
            ...
            perform: go("/school/settings"),
            perm: "Permissions.SchoolSettings.Manage",
          },
          {
            id: "nav-school-rooms",
            label: "Аудитории",
            hint: "Помещения для очных занятий",
            Icon: DoorOpen,
            keywords: ["rooms", "аудитории", "кабинеты", "помещения", "школа"],
            perform: go("/school/rooms"),
            perm: "Permissions.Scheduling.Rooms.View",
          },
          {
            id: "nav-school-non-working-days",
            label: "Нерабочие дни",
            hint: "Календарь исключений для расписания",
            Icon: CalendarX2,
            keywords: ["non-working days", "нерабочие дни", "праздники", "выходные", "календарь"],
            perform: go("/school/non-working-days"),
